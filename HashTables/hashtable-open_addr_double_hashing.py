...
#When collision happens, find the next open slot using doubl hashing 
...
class Hash:    
    ...
    def insert1(self, newItem):
        ...
        for i in range(1,self.tablesize):
            ...
            if type(key) == str:
                ...
                pos = (h1 + i * (7-(key % 7))) % self.tablesize  
    ...
    def search(self, key):
        ...
        for i in range(1,self.tablesize):
            ...
            if type(key) == str:
                sum1 = self.SumofAsciiCode(key)
                pos = (h + i * (7-(sum1 % 7))) % self.tablesize              
            else:
                pos = (h + i * (7-(key % 7))) % self.tablesize   
