...
#When collision happens, find the next open slot using linear probing
...
class Hash:    
    ...
    def insert1(self, newItem):
        ...
        for i in range(1,self.tablesize):
            ...
            #Collision, Find next spot using Linear probing
            pos = (h1 + i) % self.tablesize  
